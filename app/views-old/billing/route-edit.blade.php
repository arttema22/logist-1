...
@section('title')
Изменение тарифного маршрута
@endsection

@section('content')
<div class="container px-4 py-5">
    <h1 class="mt-5">Изменение тарифного маршрута</h1>
    ...
    @endif
    <form method="post" action="{{ route('billing.route-update', $RouteBilling->id) }}">
        @csrf
        <!-- Начало маршрута -->
        <div class="form-floating mb-3">
            <input type="text" name="start" id="start" placeholder="Начало маршрута"
                class="form-control form-control-lg" value="{{ $RouteBilling->start }}">
        ...
        <div class="form-floating mb-3">
            <input type="text" name="finish" id="finish" placeholder="Конец маршрута"
                class="form-control form-control-lg" value="{{ $RouteBilling->finish }}">
            ...
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="form-check form-switch">
                    <input name="collapse-new-type" class="form-check-input" type="checkbox" role="switch"
                        ...
                        aria-controls="collapseType" @if ($RouteBilling->is_static) checked @endif>
                    <label class="form-check-label" for="flexSwitchCheckType">цена</label>
                </div>
            </div>
            <div class="card-body">
                <div class="collapse collapse-type @if (!$RouteBilling->is_static) show @endif" id="collapseType">
                    <div class="form-floating mb-3">
                        <input type="number" step="any" name="length" id="length" placeholder="Расстояние"
                            class="form-control form-control-lg" value="{{ $RouteBilling->length }}">
                ...
                <div class="collapse collapse-type @if ($RouteBilling->is_static) show @endif" id="collapseType">
                    <div class="form-floating mb-3">
                        <input type="number" step="any" name="price" id="price" placeholder="Цена"
                            class="form-control form-control-lg" value="{{ $RouteBilling->price }}">
